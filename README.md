...
For more information and citation, please use the following:

*   **Primary Publication**:
    > Loukojärvi, M., Mahadevan, A., Haitsiukevich, K., & Puolamäki, K. (2026). PhiPlot: A Web-Based Interactive EDA Environment for Atmospherically Relevant Molecules. *EuroVis 2026 - Posters and Demos*. The Eurographics Association. <https://doi.org/10.2312/evpd.20261008>
